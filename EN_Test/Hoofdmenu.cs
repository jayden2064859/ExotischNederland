    ...
    {     
        ...
        public static void Medewerker()
        {
            ...
            do
            {
                ...
                if (userInputMenu == "6")
                { 
                    string vmConnectionUrl = "https://portal.azure.com/#@zkoo.onmicrosoft.com/resource/subscriptions/8d9ee96d-4dfb-422e-880b-151705e0d558/resourceGroups/341-A1A-groep-02/providers/Microsoft.Compute/virtualMachines/ExotischVM/connect";

                    // Dit opent de Azure portal pagina voor de VM in de browser
                    System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo(vmConnectionUrl) { UseShellExecute = true });
                    Console.Clear();
                }
